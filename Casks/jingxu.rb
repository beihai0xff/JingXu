cask "jingxu" do
  version "0.6.0"
  sha256 "ba09daecab47e43c8c89846c9b9ac117f356dd7d47c7bfc26482de806564c5e8"

  url "https://github.com/beihai0xff/JingXu/releases/download/v#{version}/JingXu-0.6.0-test.27-macOS-arm64.dmg"
  name "镜序"
  name "JingXu"
  ...
  caveats <<~EOS
    ...
    JingXu 0.6.0 can migrate complete legacy v4 catalogs after making a backup.
